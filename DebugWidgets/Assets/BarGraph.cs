...
public class BarGraph : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        var height = rectTransform.sizeDelta.y * rectTransform.localScale.y;
        
        if (Min < 0){
            BarTransform.localPosition = new Vector3(width / 2, height);
            signedDisplay = true;
        }
        else {
            signedDisplay = false;
    ...
    public void SetWidthPercent(float value, Color c)
    {
        ...
        BarTransform.localScale = new Vector3(xScale, currentScale.y);
    }
